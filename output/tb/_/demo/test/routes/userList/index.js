define('demo:client/routes/userList/index.jsx', function(require, exports, module) {
  ...
  var UserList = (function (_Component) {
      ...
      _createClass(UserList, [{
          ...
          value: function componentDidMount() {
              (0, _isomorphicFetch2['default'])('https://www.reddit.com/r/frontend.json').then(function (res) {
                  return res.json();
              }).then(function (data) {
                  console.log(data);
              });
